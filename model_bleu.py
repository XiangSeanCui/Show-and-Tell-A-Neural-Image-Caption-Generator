...
def test(args):
    ...
    '''
    train_json_path = '/u/training/tra379/final_project/captions_train2014.json'
    test_json_path = '/u/training/tra379/final_project/captions_val2014.json'
    train_image_dir = '/u/training/tra379/final_project/resized_2014/'
    test_image_dir = '/projects/training/bauh/COCO/val2014/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default=PATH + 'scratch/model_layer_10/encoder-10-5-3000.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default=PATH + 'scratch/model_layer_10/decoder-10-5-3000.ckpt', help='path for trained decoder')
    parser.add_argument('--vocab_path', type=str, default=PATH + 'final_project/data/vocab_self_new.pkl', help='path for vocabulary wrapper')

    # Model parameters (should be same as paramters in train.py)
    parser.add_argument('--embed_size', type=int, default=512, help='dimension of word embedding vectors')
    parser.add_argument('--hidden_size', type=int, default=512, help='dimension of lstm hidden states')
    parser.add_argument('--num_layers', type=int, default=10, help='number of layers in lstm')
    args = parser.parse_args()
    self_score, theoratical_score = test(args)
    np.save('bleu_score-{}.npy'.format(args.num_layers), [self_score, theoratical_score])
