...
def main(args):
    ...
    # encoder = torch.load('./model/encoder-final').eval()
    # decoder = torch.load('./model/decoder-final').eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='/home/ubuntu/final_project/model/encoder-5-3000.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='/home/ubuntu/final_project/model/decoder-5-3000.ckpt', help='path for trained decoder')
